  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_S_inner2,"0")){ //3.1
      ...
      if (equal(Term_dom_S_inner1,"0")){ //3.1.1
        ...
        if (isNat(T)) return "ψ_"+S.sub+"("+fund(S.inner1,"0")+","+fund(S,fund(T,"0"))+")"; //3.1.2.1
        else return "ψ_"+S.sub+"("+fund(S.inner1,"0")+","+S.inner2+")"; //3.1.2.2
      }else{ //3.1.3
        if (lessThan(Term_dom_S_inner1,S)) return "ψ_"+S.sub+"("+fund(S.inner1,T)+","+S.inner2+")"; //3.1.3.1
          ...
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner2,S.inner2)) return "ψ_"+S.sub+"("+fund(S.inner1,"ψ_"+fund(d,"0")+"("+Term_fund_S_fund_T_0.inner1+",0)")+","+S.inner2+")"; //3.1.3.2.1
          else return "ψ_"+S.sub+"("+fund(S.inner1,"ψ_"+fund(d,"0")+"(0,0)")+","+S.inner2+")"; //3.1.3.2.2
        }
      }
      ...
      if (lessThan(Term_dom_S_inner2,S)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,T)+")"; //3.3.1
        ...
        if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+fund(d,"0")+"("+Term_fund_S_fund_T_0.inner2+",0)")+")"; //3.3.2.1
        else return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+fund(d,"0")+"(0,0)")+")"; //3.3.2.2
      }
    }
  }
...
/**
 * @param {number} n 
 * @returns {string} ψ_0(Λ(n),0)
 */
function limitOrd(n){
  return "ψ_0("+"ψ_".repeat(n+1)+"0"+"(0,0)".repeat(n+1)+",0)";
}
/**
 * @param {string} X 
 * @param {number} n 
