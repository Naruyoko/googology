...
function dom(S){
  ...
  if (S instanceof SumTerm){ //2
    ...
    if (equal(dom(S_getRight.inner),Term.ONE)){ //2.1
      ...
      if (equal(Term_dom_S_getNotLeft,Term.ONE_PLUS_SMALLOMEGA)) return dom_S_getNotLeft; //2.1.1
        ...
        if (lessThan(Term_dom_S_getNotLeft,S)) return Term.SMALLOMEGA+""; //2.1.2.1
        else return Term.ONE_PLUS_SMALLOMEGA+""; //2.1.2.2
      }
  ...
  if (S instanceof PsiTerm){ //3
    ...
    }else if (equal(Term_dom_S_inner,Term.ONE)) return S+""; //3.2
    else if (equal(Term_dom_S_inner,Term.ONE_PLUS_SMALLOMEGA)) return Term.SMALLOMEGA+""; //3.3
    else{ //3.4
      if (!(Term_dom_S_inner instanceof PsiTerm)) throw Error("Assertion failed");
      if (equal(dom(Term_dom_S_inner.inner),Term.ONE)) return Term.SMALLOMEGA+""; //3.4.1
      else{ //3.4.2
        if (lessThan(Term_dom_S_inner,S)) return dom_S_inner; //3.4.2.1
        else return Term.SMALLOMEGA+""; //3.4.2.2
      }
    }
  }
...
function fund(S,T){
  ...
  if (S instanceof SumTerm){ //2
    ...
    if (equal(dom(S_getRight.inner),Term.ONE)){ //2.1
      ...
      if (equal(Term_dom_S_getNotLeft,Term.ONE_PLUS_SMALLOMEGA)) return S_getLeft+"+"+fund(S_getNotLeft,T); //2.1.1
        ...
        if (lessThan(Term_dom_S_getNotLeft,S)){ //2.1.2.1
          if (equal(dom(T),Term.ONE)) return S.getNotRight()+"+"+fund(S_getRight,Term.ZERO)+"+"+fund(S,fund(T,Term.ZERO)); //2.1.2.1.1
          else return S.getNotRight()+"+"+fund(S_getRight,Term.ZERO); //2.1.2.1.2
        }else return S_getLeft+"+"+fund(S_getNotLeft,T); //2.1.2.2
      }
    }else{ //2.2
  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //3.1
      ...
      if (!(Term_dom_S_inner instanceof PsiTerm)) throw Error("Assertion failed");
      if (equal(dom(Term_dom_S_inner.inner),Term.ONE)) return "ψ("+S.sub+","+fund(S.inner,T)+")"; //3.4.1
      else{ //3.4.2
        if (lessThan(Term_dom_S_inner,S)) return "ψ("+S.sub+","+fund(S.inner,T)+")"; //3.4.2.1
        else{ //3.4.2.2
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(Term_dom_S_inner.sub,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //3.4.2.2.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(Term_dom_S_inner.sub,Term.ZERO)+",0)")+")"; //3.4.2.2.2
        }
      }
    }
  }
 ...
 */
function limitOrd(n){
  return "ψ(0,"+"ψ(".repeat(n+1)+"0"+",0)".repeat(n+1)+")";
}
...
var testTermsPre=[
  ...
  ["ψ_0(ψ_1(0)+ψ_0(ψ_1(0))+ψ_1(0))",3],
  ["ψ_0(ψ_1(0)+ψ_0(ψ_1(0))+ψ_1(0)+ω)",3],
  ...
  ["ψ_0(ψ_1(ψ_1(0)))",3],
  ["ψ_0(ψ_1(ψ_1(1)))",-1],
  ["ψ_0(ψ_1(ψ_1(1))+1+ψ_1(ψ_1(0)+1))",3],
  ["ψ_0(ψ_1(ψ_1(1))+ω)",3],
  ["ψ_0(ψ_1(ψ_1(1))+ω+ψ_1(ψ_1(0)+1))",3],
  ["ψ_0(ψ_1(ψ_1(1))+ψ_0(ψ_1(0))+ψ_1(ψ_1(0)+1))",3],
  ["ψ_0(ψ_1(ψ_1(1))+ψ_0(ψ_1(0)+1)+ψ_1(ψ_1(0)+1))",3],
  ["ψ_0(ψ_2(0))",3],
  ["ψ_0(ψ_2(0)+1+ψ_1(1))",3],
  ["ψ_0(ψ_2(0)+1+ψ_2(0))",-1],
  ["ψ_0(ψ_2(0)+ω)",3],
  ...
  ["ψ_0(ψ_2(1)+1+ψ_2(0))",-1],
  ["ψ_0(ψ_2(1)+ω)",3],
  ["ψ_0(ψ_2(1)+ψ_0(2)+ψ_1(1))",3],
  ["ψ_0(ψ_2(1)+ψ_0(2)+ψ_2(1))",3],
  ["ψ_0(ψ_2(1)+ψ_1(0))",3],
  ["ψ_0(ψ_2(1)+ψ_1(0)+ω)",3],
  ...
  ["ψ_0(ψ_ω(1)+1+ψ_ω(1))",3],
  ["ψ_0(ψ_ω(1)+ω)",3],
  ["ψ_0(ψ_ω(1)+ψ_1(0)+ψ_ω(1))",3],
  ["ψ_0(ψ_ω(1)+ψ_ω(0)+ψ_ω(1))",3],
  ["ψ_0(ψ_ω(1)+ψ_ω(1))",3],
  ["ψ_0(ψ_ω(ω))",-1],
  ["ψ_0(ψ_ω(ψ_1(0)))",-1],
  ["ψ_0(ψ_ω(ψ_ω(0)))",-1],
  ...
  ["ψ_0(ψ_ψ_1(0)(0))",3],
  ["ψ_0(ψ_ψ_1(1)(0))",3],
  ["ψ_0(ψ_{ψ_1(1)+1+ψ_1(1)}(0))",3],
  ["ψ_0(ψ_{ψ_1(1)+ω+ψ_1(1)}(0))",3],
  ["ψ_0(ψ_{ψ_1(1)+ψ_1(0)+ψ_1(1)}(0))",3],
  ["ψ_0(ψ_{ψ_1(1)+ψ_1(1)}(0))",3],
  ["ψ_0(ψ_ψ_1(2)(0))",-1],
  ["ψ_0(ψ_ψ_2(0)(0))",3],
  ["ψ_0(ψ_ψ_ω(0)(0))",3],
  ["ψ_0(ψ_ψ_ψ_1(0)(0)(0))",-1],
