 ...
 * @param {Term|string} gamma
 * @param {number} br
 * @returns {string}
 */
function con(bp,gamma,br){
  if (!(bp instanceof Term)) bp=new Term(bp);
  if (!inRT(bp)||!inRT(gamma)||typeof br!="number") throw Error("Invalid argument: "+bp+","+gamma+","+br);
  if (bp instanceof ZeroTerm) return gamma+""; //1
  if (bp instanceof SumTerm) return bp.terms.map(function (t){return con(t,gamma,br);}).join("+"); //2
  if (bp instanceof PsiTerm){ //3
    var a=toNat(bp.sub);
    var b=bp.inner;
    if (a<=br) return bp+""; //3.1
    else return "ψ("+bp.sub+","+con(b,gamma,br)+")"; //3.2
  }
  throw Error("No rule to compute delta("+bp+","+gamma+","+br+")");
}
/**
 * @param {Term|string} S
 * @returns {string}
...
function fund(S,T){
  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)) return T+""; //3.1
      ...
      if (a>=c) return "ψ("+S.sub+","+fund(S.inner,T)+")"; //3.3.1
      else{ //3.3.2
        if (c-a==1){ //3.3.2.1
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+normalizeAbbreviations(c-1)+","+Term_fund_S_fund_T_0.inner+")")+")"; //3.3.2.1.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ("+normalizeAbbreviations(c-1)+",0)")+")"; //3.3.2.1.2
        }else{ //3.3.2.2
          var Term_fund_S_fund_T_0=null;
          var Term_fund_S_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&(Term_fund_S_0=new Term(fund(S,Term.ZERO))) instanceof PsiTerm&&equal(Term_fund_S_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+normalizeAbbreviations(c-1)+","+con(Term_fund_S_fund_T_0.inner,Term_fund_S_0.inner,a)+")")+")"; //3.3.2.2.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ("+normalizeAbbreviations(c-1)+",0)")+")"; //3.3.2.2.2
        }
      }
    }
  }
...
var testTermsPre=[
  ...
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(0)+ψ_2(0)))",3],
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(ψ_2(0))))",3],
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(ψ_2(0))+ψ_1(0)))",3],
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(ψ_2(0))+ψ_1(ψ_2(ψ_2(0))+ψ_1(0))))",3],
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(ψ_2(0))+ψ_1(ψ_2(ψ_2(ψ_2(0))))))",3],
  ["ψ_0(ψ_2(0)+ψ_1(ψ_2(ψ_2(0))+ψ_2(0)))",3],
  ["ψ_0(ψ_2(0)+ψ_2(0))",3],
  ["ψ_0(ψ_2(0)+ψ_2(0)+ψ_2(0))",3],
  ["ψ_0(ψ_2(1))",3],
  ["ψ_0(ψ_2(ψ_0(ψ_2(0))))",3],
  ["ψ_0(ψ_2(ψ_1(0)))",3],
  ["ψ_0(ψ_2(ψ_1(0))+ψ_2(0))",3],
  ["ψ_0(ψ_2(ψ_2(0)))",3],
  ["ψ_0(ψ_2(ψ_2(0)+ψ_2(0)))",3],
  ["ψ_0(ψ_3(0))",3],
  ["ψ_0(ψ_3(0)+ψ_1(ψ_3(0)+ψ_3(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_1(ψ_3(ψ_1(0))+ψ_3(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_1(ψ_3(ψ_2(0))+ψ_3(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_1(ψ_3(ψ_3(0)+ψ_1(0))))",3],
  ["ψ_0(ψ_3(0)+ψ_2(0))",3],
  ["ψ_0(ψ_3(0)+ψ_2(ψ_3(0)+ψ_2(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_2(ψ_3(ψ_1(0))+ψ_2(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_2(ψ_3(ψ_2(0))+ψ_2(0)))",3],
  ["ψ_0(ψ_3(0)+ψ_2(ψ_3(ψ_3(0)+ψ_2(0))))",3],
  ["ψ_0(ψ_3(0)+ψ_3(0))",3],
  ["ψ_0(ψ_3(1))",3],
  ["ψ_0(ψ_3(1)+ψ_3(0))",3],
  ["ψ_0(ψ_3(ψ_1(0))+ψ_3(0))",3],
  ["ψ_0(ψ_3(ψ_2(0))+ψ_3(0))",3],
  ["ψ_0(ψ_3(ψ_3(0)))",3],
  ["ψ_0(ψ_3(ψ_3(0))+ψ_3(0))",3],
  ["ψ_0(ψ_4(0))",3]
];
/** @type {string[]}} */
var testTerms;
    ...
    if (oldinput!=input){
      ...
      try{
        if (cmd=="normalize"||cmd=="norm"){
          ...
          result=inRPT(args[0]);
        }else if (cmd=="con"||cmd=="connect"||cmd=="delta"){
          result=con(args[0],args[1],+args[2]);
        }else if (cmd=="dom"){
          result=dom(args[0]);
