  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_S_inner3,Term.ZERO)){ //3.1
      ...
      if (equal(Term_dom_S_inner2,Term.ZERO)){ //3.1.1
        ...
        if (equal(Term_dom_S_inner1,Term.ZERO)) return S+""; //3.1.1.1
        else if (equal(Term_dom_S_inner1,Term.ONE)) return Term.SMALLOMEGA+""; //3.1.1.2
        else return dom_S_inner1; //3.1.1.3
      }else if (equal(Term_dom_S_inner2,Term.ONE)) return S+""; //3.1.2
      else{ //3.1.3
        if (lessThan(Term_dom_S_inner2,S)) return dom_S_inner2; //3.1.3.1
        else return Term.SMALLOMEGA+""; //3.1.3.2
      }
  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_S_inner3,Term.ZERO)){ //3.1
      ...
      if (equal(Term_dom_S_inner2,Term.ZERO)){ //3.1.1
        var dom_S_inner1=dom(S.inner1);
        var Term_dom_S_inner1=new Term(dom_S_inner1);
        if (equal(Term_dom_S_inner1,Term.ZERO)) return T+""; //3.1.1.1
        else if (equal(Term_dom_S_inner1,Term.ONE)){ //3.1.1.2
          var Term_fund_S_fund_T_0=null;
          if (isNat(T)) return "ψ("+fund(S.inner1,Term.ZERO)+","+fund(S,fund(T,Term.ZERO))+","+S.inner3+")"; //3.1.1.2.1
          else return "ψ("+fund(S.inner1,Term.ZERO)+","+S.inner2+","+S.inner3+")"; //3.1.1.2.2
        }else return "ψ("+fund(S.inner1,T)+","+S.inner2+","+S.inner3+")"; //3.1.1.3
        ...
        if (lessThan(Term_dom_S_inner2,S)) return "ψ("+S.inner1+","+fund(S.inner2,T)+","+S.inner3+")"; //3.1.3.1
          ...
          var Term_fund_S_fund_T_0=null;
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)&&equal(Term_fund_S_fund_T_0.inner3,S.inner3)) return "ψ("+S.inner1+","+fund(S.inner2,"ψ("+d+","+fund(e,Term.ZERO)+","+Term_fund_S_fund_T_0.inner2+")")+","+S.inner3+")"; //3.1.3.2.1
          else return "ψ("+S.inner1+","+fund(S.inner2,"ψ("+d+","+fund(e,Term.ZERO)+",0)")+","+S.inner3+")"; //3.1.3.2.2
        }
      }
      ...
      if (lessThan(Term_dom_S_inner3,S)) return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,T)+")"; //3.3.1
        ...
        var Term_fund_S_fund_T_0=null;
        if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)&&equal(Term_fund_S_fund_T_0.inner2,S.inner2)) return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+d+","+fund(e,Term.ZERO)+","+Term_fund_S_fund_T_0.inner3+")")+")"; //3.3.2.1
        else return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+d+","+fund(e,Term.ZERO)+",0)")+")"; //3.3.2.2
      }
    }
  }
...
var testTermsPre=[
  ...
  ["ψ_0(0,ψ_1(0,1))",-1],
  ["ψ_0(0,ψ_1(0,ψ_0(1,0)))",-1],
  ["ψ_0(0,ψ_1(0,ψ_1(0,0)))",3],
  ["ψ_0(0,ψ_1(1,0))",3],
  ["ψ_0(0,ψ_1(1,0)+ψ_0(1,ψ_1(1,0)))",-1],
  ["ψ_0(0,ψ_1(1,0)+ψ_1(0,0))",-1],
  ["ψ_0(0,ψ_1(1,0)+ψ_1(0,ψ_1(1,0)))",3],
  ["ψ_0(0,ψ_1(1,0)+ψ_1(1,0))",3],
  ["ψ_0(0,ψ_1(1,ψ_1(0,0)))",3],
  ["ψ_0(0,ψ_1(2,0))",3],
  ["ψ_0(0,ψ_1(2,0)+ψ_1(0,0))",-1],
  ["ψ_0(0,ψ_1(2,0)+ψ_1(2,0))",-1],
  ["ψ_0(0,ψ_1(ω,0))",-1],
  ["ψ_0(0,ψ_1(ω+1,0))",-1],
  ["ψ_0(0,ψ_1(ψ_0(1,0),0))",-1],
  ["ψ_0(0,ψ_1(ψ_1(0,0),0))",-1],
  ["ψ_0(0,ψ_1(ψ_1(1,0),0))",-1],
  ["ψ_0(0,ψ_2(0,0))",3],
  ["ψ_0(0,ψ_2(0,0)+ψ_1(0,0))",3],
  ["ψ_0(0,ψ_2(0,0)+ψ_1(0,ψ_2(0,0)))",3],
  ["ψ_0(0,ψ_2(0,0)+ψ_1(1,0))",3],
  ["ψ_0(0,ψ_2(0,0)+ψ_2(0,0))",3],
  ["ψ_0(0,ψ_2(0,ψ_2(0,0)))",3],
  ["ψ_0(0,ψ_2(1,0))",-1],
  ["ψ_0(0,ψ_2(1,ψ_2(0,ψ_2(1,0))))",3],
  ["ψ_0(0,ψ_2(1,ψ_2(1,0)))",3],
  ["ψ_0(0,ψ_2(ψ_0(1,0),0))",-1],
  ["ψ_0(0,ψ_2(ψ_1(0,0),0))",-1],
  ["ψ_0(0,ψ_2(ψ_1(1,0),0))",3],
