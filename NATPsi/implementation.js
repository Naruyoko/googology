...
function fund(S,T){
  ...
  if (S instanceof PsiTerm){ //3
    ...
    if (equal(Term_dom_c,Term.ZERO)) return T+""; //3.1
      ...
      if (e==0){ //3.3.1
        if (a<d){ //3.3.1.1
          if (isNat(T)&&!equal(T,Term.ZERO)) return "ψ("+a+","+b+","+fund(c,fund(S,fund(T,Term.ZERO)))+")"; //3.3.1.1.1
          else return "ψ("+a+","+b+","+fund(c,Term.ZERO)+")"; //3.3.1.1.2
        }else return "ψ("+a+","+b+","+fund(c,T)+")"; //3.3.1.2
      }else{ //3.3.2
        if (b<e){ //3.3.2.1
          if (a<=d){ //3.3.2.1.1
            if (isNat(T)&&!equal(T,Term.ZERO)) return "ψ("+a+","+b+","+fund(c,fund(S,fund(T,Term.ZERO)))+")"; //3.3.2.1.1.1
            else return "ψ("+a+","+b+","+fund(c,Term.ZERO)+")"; //3.3.2.1.1.2
