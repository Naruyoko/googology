...
function inT(t){
  ...
  if (t instanceof ThetaTerm) return inT(t.sub)&&inT(t.inner); //3
...
function dom(S){
  ...
  if (S instanceof ThetaTerm){ //3
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //3.1
      ...
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)||equal(Term_dom_S_sub,"θ(0,0)")) return S+""; //3.1.1
      else return dom_S_sub; //3.1.2
  ...
  if (S instanceof PsiTerm){ //4
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //4.1
      ...
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)) return S+""; //4.1.1
        ...
        else return Term.SMALLOMEGA+""; //4.1.2.2
      }
...
function fund(S,T){
  ...
  if (S instanceof ThetaTerm){ //3
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //3.1
      var dom_S_sub=dom(S.sub);
      var Term_dom_S_sub=new Term(dom_S_sub);
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)||equal(Term_dom_S_sub,"θ(0,0)")) return T+""; //3.1.1
      ...
      if (lessThan(Term_dom_S_inner,S)) return "θ("+S.sub+","+fund(S.inner,T)+")"; //3.3.1
        ...
        if (!(Term_dom_S_inner instanceof ThetaTerm&&equal(Term_dom_S_inner.inner,Term.ZERO))) throw Error("Unexpected error");
        var c=Term_dom_S_inner.sub;
        if (equal(dom(c),Term.ONE)){ //3.3.2.1
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof ThetaTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "θ("+S.sub+","+fund(S.inner,"θ("+fund(c,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //3.3.2.1.1
          else return "θ("+S.sub+","+fund(S.inner,"θ("+fund(c,Term.ZERO)+",0)")+")"; //3.3.2.1.2
        }else{ //3.3.2.2
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof ThetaTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "θ("+S.sub+","+fund(S.inner,"θ("+fund(c,"ψ("+Term_fund_S_fund_T_0.inner+",0)")+",0)")+")"; //3.3.2.2.1
          else return "θ("+S.sub+","+fund(S.inner,"θ("+fund(c,"ψ(0,0)")+",0)")+")"; //3.3.2.2.2
        }
      }
    }
  }
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //4.1
      ...
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)) return T+""; //4.1.1
        ...
        if (lessThan(Term_dom_S_sub,S)) return "ψ("+fund(S.sub,T)+","+S.inner+")"; //4.1.2.1
          ...
          if (!(Term_dom_S_sub instanceof ThetaTerm&&equal(Term_dom_S_sub.inner,Term.ZERO))) throw Error("Unexpected error");
          var c=Term_dom_S_sub.sub;
          var dom_c=dom(c);
          var Term_dom_c=new Term(dom_c);
          if (equal(Term_dom_c,Term.ZERO)){ //4.1.2.2.1
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,"ψ("+Term_fund_S_fund_T_0.sub+",0)")+","+S.inner+")"; //4.1.2.2.1.1
            else return "ψ("+fund(S.sub,"ψ(0,0)")+","+S.inner+")"; //4.1.2.2.1.2
          }else if (equal(Term_dom_c,Term.ONE)){ //4.1.2.2.2
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,"θ("+fund(c,Term.ZERO)+","+Term_fund_S_fund_T_0.sub+")")+","+S.inner+")"; //4.1.2.2.2.1
            else return "ψ("+fund(S.sub,"θ("+fund(c,Term.ZERO)+",0)")+","+S.inner+")"; //4.1.2.2.2.2
          }else{ //4.1.2.2.3
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,"θ("+fund(c,"ψ("+Term_fund_S_fund_T_0.sub+",0)")+",0)")+","+S.inner+")"; //4.1.2.2.3.1
            else return "ψ("+fund(S.sub,"θ("+fund(c,"ψ(0,0)")+",0)")+","+S.inner+")"; //4.1.2.2.3.2
          }
        }
      }
      ...
      if (lessThan(Term_dom_S_inner,S)) return "ψ("+S.sub+","+fund(S.inner,T)+")"; //4.3.1
        ...
        if (Term_dom_S_inner instanceof PsiTerm&&equal(Term_dom_S_inner.inner,Term.ZERO)){ //4.3.2.1
          var c=Term_dom_S_inner.sub;
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(c,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //4.3.2.1.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(c,Term.ZERO)+",0)")+")"; //4.3.2.1.2
        }else if (Term_dom_S_inner instanceof ThetaTerm&&equal(Term_dom_S_inner.inner,Term.ZERO)){ //4.3.2.2
          var c=Term_dom_S_inner.sub;
          var dom_c=dom(c);
          var Term_dom_c=new Term(dom_c);
          if (equal(Term_dom_c,Term.ZERO)){ //4.3.2.2.1
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+Term_fund_S_fund_T_0.inner+",0)")+")"; //4.3.2.2.1.1
            else return "ψ("+S.sub+","+fund(S.inner,"ψ(0,0)")+")"; //4.3.2.2.1.2
          }else if (equal(Term_dom_c,Term.ONE)){ //4.3.2.2.2
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"θ("+fund(c,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //4.3.2.2.2.1
            else return "ψ("+S.sub+","+fund(S.inner,"θ("+fund(c,Term.ZERO)+",0)")+")"; //4.3.2.2.2.2
          }else{ //4.3.2.2.3
            var Term_fund_S_fund_T_0=null;
            if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"θ("+fund(c,"ψ("+Term_fund_S_fund_T_0.inner+",0)")+",0)")+")"; //4.3.2.2.3.1
            else return "ψ("+S.sub+","+fund(S.inner,"θ("+fund(c,"ψ(0,0)")+",0)")+")"; //4.3.2.2.3.2
          }
        }
      }
    }
 ...
 */
function limitOrd(n){
  return "ψ(0,"+"θ(".repeat(n+1)+"0"+",0)".repeat(n+1)+")";
}
...
var testTermsPre=[
  ...
  ["ψ_0(ψ_ψ_ω(0)(0))",3],
  ["ψ_0(θ_0(0))",3],
  ["ψ_0(θ_0(0)+ψ_1(θ_0(0)))",3],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)(θ_0(0)))",3],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)+1(0))",3],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)+1(θ_0(0)))",3],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)+2(0))",-1],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)+ψ_θ_0(0)(0)(0))",-1],
  ["ψ_0(θ_0(0)+ψ_θ_0(0)+ψ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(θ_0(0)+θ_0(0))",3],
  ["ψ_0(θ_0(0)+θ_0(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(θ_0(0)+θ_0(0)+ψ_θ_0(0)+θ_0(0)(0))",3],
  ["ψ_0(θ_0(0)+θ_0(0)+θ_0(0))",-1],
  ["ψ_0(θ_0(1))",3],
  ["ψ_0(θ_0(ψ_1(0)))",-1],
  ["ψ_0(θ_0(ψ_θ_0(0)(0)))",3],
  ["ψ_0(θ_0(ψ_θ_0(0)+1(0)))",3],
  ["ψ_0(θ_0(ψ_θ_0(1)(0)))",3],
  ["ψ_0(θ_0(θ_0(0)))",3],
  ["ψ_0(θ_0(θ_0(0))+ψ_θ_0(θ_0(0))(0))",3],
  ["ψ_0(θ_0(θ_0(θ_0(0))))",-1],
  ["ψ_0(θ_1(0))",3],
  ["ψ_0(θ_1(0)+ψ_1(θ_1(0)))",3],
  ["ψ_0(θ_1(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(θ_1(0)+ψ_θ_1(0)(0))",3],
  ["ψ_0(θ_1(0)+θ_0(0))",3],
  ["ψ_0(θ_1(0)+θ_0(θ_1(0)))",3],
  ["ψ_0(θ_1(0)+θ_1(0))",3],
  ["ψ_0(θ_1(0)+θ_1(0)+ψ_θ_1(0)+θ_0(0)(0))",3],
  ["ψ_0(θ_1(0)+θ_1(0)+ψ_θ_1(0)+θ_0(θ_1(0))(0))",3],
  ["ψ_0(θ_1(0)+θ_1(0)+ψ_θ_1(0)+θ_1(0)(0))",3],
  ["ψ_0(θ_1(0)+θ_1(0)+θ_0(0))",-1],
  ["ψ_0(θ_1(0)+θ_1(0)+θ_1(0))",-1],
  ["ψ_0(θ_1(1))",-1],
  ["ψ_0(θ_1(ψ_θ_1(0)(0)))",-1],
  ["ψ_0(θ_1(θ_0(0)))",3],
  ["ψ_0(θ_1(θ_0(θ_1(0))))",3],
  ...
  ["ψ_0(θ_ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(θ_θ_0(0)(0))",3],
  ["ψ_0(θ_θ_0(0)(1)+ψ_θ_θ_0(0)(0)+θ_0(θ_θ_0(0)(0))(0))",3],
  ["ψ_0(θ_θ_0(0)(1)+ψ_θ_θ_0(0)(0)+θ_1(0)(0))",3],
  ["ψ_0(θ_θ_1(0)(0))",3],
  ["ψ_0(θ_θ_θ_0(0)(0)(0))",3],
  ["ψ_0(θ_θ_θ_0(0)(0)(1)+ψ_θ_θ_θ_0(0)(0)(0)+θ_0(θ_θ_θ_0(0)(0)(0))(0))",3],
  ["ψ_0(θ_θ_θ_0(0)(0)(1)+ψ_θ_θ_θ_0(0)(0)(0)+θ_θ_0(0)(θ_θ_θ_0(0)(0)(0))(0))",3],
  ["ψ_0(θ_θ_θ_θ_0(0)(0)(0)(0))",3]
];
/** @type {string[]}} */
var testTerms;
