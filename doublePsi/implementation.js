    ...
    if (equal(Term_dom_S_inner2,"0")){ //3.1
      ...
      if (equal(Term_dom_S_inner1,"0")){ //3.1.1
        ...
        if (lessThan(Term_dom_S_inner1,"1")) return dom_S_inner1; //3.1.3.1
          ...
          if (equal(dom(e),"0")) return S+""; //3.1.3.2.1
          else return normalizeAbbreviations("ω"); //3.1.3.2.2
        }
      }
...
function bp(S,T){
  ...
  if (S instanceof PsiTerm){ //3
    if (lessThan(T,S.sub)) return S+""; //3.1
      ...
      if (lessThan(S.inner1,S)) return S+""; //3.2.1
      else return bp(S.inner1,T); //3.2.2
    }
  }
    ...
    if (equal(Term_dom_S_inner2,"0")){ //3.1
      ...
      if (equal(Term_dom_S_inner1,"0")){ //3.1.1
        ...
        if (lessThan(Term_dom_S_inner1,S)) return "ψ_"+S.sub+"("+fund(S.inner1,T)+","+S.inner2+")"; //3.1.3.1
          ...
          var e=Term_dom_S_inner1.inner1;
          var dom_e=dom(e);
          var Term_dom_e=new Term(dom_e);
          if (equal(Term_dom_e,"0")){ //3.1.3.2.1
            if (equal(T,"0")) return "ψ_"+S.sub+"("+fund(S.inner1,"ψ_"+fund(d,"0")+"("+e+",0)")+","+S.inner2+")"; //3.1.3.2.1.1
            ...
            else if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner2,S.inner2)) return "ψ_"+S.sub+"("+fund(S.inner1,"ψ_"+(fund_f_0=fund(f,"0"))+"("+bp(Term_fund_S_fund_T_0.inner1,fund_f_0)+",0)")+","+S.inner2+")"; //3.1.3.2.3.2
            else return "ψ_"+S.sub+"("+fund(S.inner1,T)+","+S.inner2+")"; //3.1.3.2.3.3
          }
        }
      }
      ...
      else return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"0")+")"; //3.2.2
    }else{ //3.3
      if (lessThan(Term_dom_S_inner2,S)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,T)+")"; //3.3.1
      else{ //3.3.2
        ...
        var dom_e=dom(e);
        var Term_dom_e=new Term(dom_e);
        if (equal(Term_dom_e,"0")){ //3.3.2.1
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+fund(d,"0")+"("+Term_fund_S_fund_T_0.inner2+",0)")+")"; //3.3.2.1.1
          else return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+fund(d,"0")+"("+e+",0)")+")"; //3.3.2.1.2
        }else if (equal(Term_dom_e,"1")){ //3.3.2.2
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+d+"("+fund(e,"0")+","+Term_fund_S_fund_T_0.inner2+")")+")"; //3.3.2.2.1
          else return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+d+"("+fund(e,"0")+",0)")+")"; //3.3.2.2.2
        }else{ //3.3.2.3
          if (!(Term_dom_e instanceof PsiTerm)) throw Error("Unexpected error");
          var f=Term_dom_e.sub;
          if (equal(T,"0")) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"0")+")"; //3.3.2.3.1
          else if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,"0")))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)) return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,"ψ_"+(fund_f_0=fund(f,"0"))+"("+bp(Term_fund_S_fund_T_0.inner2,fund_f_0)+",0)")+")"; //3.3.2.3.2
          else return "ψ_"+S.sub+"("+S.inner1+","+fund(S.inner2,T)+")"; //3.3.2.3.3
        }
      }
    }
  }
