...
Term.build=function (s,context){
  ...
  var TOP=0;
  var THETATERMSUBSCRIPT=1;
  var THETATERMINNER=2;
  var PSITERMSUBSCRIPT=3;
  var PSITERMINNER=4;
  var BRACES=5;
  var contextNames=["TOP","THETATERMSUBSCRIPT","THETATERMINNER","PSITERMSUBSCRIPT","PSITERMINNER","BRACES"];
  ...
  while (scanner.hasNext()&&state!=EXIT){
    ...
    if (symbolType==NUMBER){
      ...
      if (nextnext=="_"){
        subterms.push(Term.build(scanner,THETATERMSUBSCRIPT));
        var nextnext=scanner.next();
      ...
      while (subterms.length<2){
        subterms.push(Term.build(scanner,THETATERMINNER));
        var nextnext=scanner.next();
        if (nextnext==","){
    ...
    if (state==CLOSEDTERM){
      ...
      if (context==BRACES&&peek=="}"){
        ...
        state=EXIT;
      }else if (context==THETATERMSUBSCRIPT&&peek=="("){
        state=EXIT;
      }else if (context==THETATERMINNER&&(peek==","||peek==")")){
        state=EXIT;
      }
    }
  }
...
ThetaTerm.prototype.toString=function (abbreviate){
  if (abbreviate){
    if ((abbreviate===true||abbreviate["1θ"])&&this.sub.equal(Term.ZERO)) return "θ("+this.inner.toString(abbreviate)+")";
    else if ((abbreviate===true||abbreviate["2θ"])) return "θ_"+this.sub.toString(abbreviate)+"("+this.inner.toString(abbreviate)+")";
  }
...
function inT(t){
  ...
  if (t instanceof SumTerm) return t.terms.every(inPT); //3
  if (t instanceof ThetaTerm) return inT(t.sub)&&inT(t.inner); //4
  if (t instanceof PsiTerm) return inT(t.sub)&&inTPsi(t.inner); //5
  return false;
}
function inPT(t){
  try{
...
function inTPsi(t){
  ...
  if (t instanceof ZeroTerm) return true; //1
  if (t instanceof SumTerm) return t.terms.every(inPTPsi); //2
  if (t instanceof PsiTerm) return inT(t.sub)&&inTPsi(t.inner); //5
  return false;
}
function inPTPsi(t){
...
function bp(S){
  ...
  if (S instanceof SumTerm){ //2
    if (inPTPsi(S.getLeft())) return S+""; //2.1
    else return bp(S.getNotLeft()); //2.2
  }
  if (S instanceof ThetaTerm){ //3
    if (equal(S.inner,Term.ZERO)) return bp(S.sub); //3.1
    else return bp(S.inner); //3.2
  }
...
function dom(S){
  ...
  if (S instanceof PsiTerm){ //4
    var dom_S_inner=dom(S.inner);
    var Term_dom_S_inner=new Term(dom_S_inner);
    if (equal(Term_dom_S_inner,Term.ZERO)){ //4.1
      var dom_S_sub=dom(S.sub);
      var Term_dom_S_sub=new Term(dom_S_sub);
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)) return S+""; //4.1.1
      else{ //4.1.2
        if (lessThan(Term_dom_S_sub,S)) return dom_S_sub; //4.1.2.1
        else{ //4.1.2.2
          if (Term_dom_S_sub instanceof ThetaTerm&&equal(Term_dom_S_sub.inner,Term.ZERO)){ //4.1.2.2.1
            if (equal(dom(Term_dom_S_sub.sub),Term.ZERO)) return S+""; //4.1.2.2.1.1
            else return Term.SMALLOMEGA+""; //4.1.2.2.1.2
          }else if (Term_dom_S_sub instanceof PsiTerm&&equal(Term_dom_S_sub.inner,Term.ZERO)) return Term.SMALLOMEGA+""; //4.1.2.2.2
        }
      }
...
function fund(S,T){
  ...
  if (S instanceof ThetaTerm){ //3
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //3.1
      ...
      else return "θ("+fund(S.sub,T)+","+S.inner+")"; //3.1.2
      ...
      else return "θ("+S.sub+","+fund(S.inner,Term.ZERO)+")"; //3.2.2
    }else{ //3.3
      if (lessThan(Term_dom_S_inner,S)) return "θ("+S.sub+","+fund(S.inner,T)+")"; //3.3.1
      else{ //3.3.2
        if (!(Term_dom_S_inner instanceof ThetaTerm&&equal(Term_dom_S_inner.inner,Term.ZERO))) throw Error("Failed assertion");
        var Term_fund_S_fund_T_0=null;
        if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof ThetaTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "θ("+S.sub+","+fund(S.inner,"θ("+fund(Term_dom_S_inner.sub,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //3.3.2.1
        else return "θ("+S.sub+","+fund(S.inner,"θ("+fund(Term_dom_S_inner.sub,Term.ZERO)+",0)")+")"; //3.3.2.2
      }
    }
  }
  if (S instanceof PsiTerm){ //4
    ...
    if (equal(Term_dom_S_inner,Term.ZERO)){ //4.1
      var dom_S_sub=dom(S.sub);
      var Term_dom_S_sub=new Term(dom_S_sub);
      if (equal(Term_dom_S_sub,Term.ZERO)||equal(Term_dom_S_sub,Term.ONE)) return T+""; //4.1.1
      else{ //4.1.2
        if (lessThan(Term_dom_S_sub,S)) return "ψ("+fund(S.sub,T)+","+S.inner+")"; //4.1.2.1
        else{ //4.1.2.2
          if (Term_dom_S_sub instanceof ThetaTerm&&equal(Term_dom_S_sub.inner,Term.ZERO)){ //4.1.2.2.1
            if (equal(dom(Term_dom_S_sub.sub),Term.ZERO)) return "ψ("+fund(S.sub,T)+","+S.inner+")"; //4.1.2.2.1.1
            else{ //4.1.2.2.1.2
              var Term_fund_S_fund_T_0=null;
              if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,"θ("+fund(Term_dom_S_sub.sub,Term.ZERO)+","+Term_fund_S_fund_T_0.sub+")")+","+S.inner+")"; //4.1.2.2.1.2.1
              else return "ψ("+fund(S.sub,"θ("+fund(Term_dom_S_sub.sub,Term.ZERO)+",0)")+","+S.inner+")"; //4.1.2.2.1.2.2
            }
          }else if (Term_dom_S_sub instanceof PsiTerm&&equal(Term_dom_S_sub.inner,Term.ZERO)){ //4.1.2.2.2
            if (equal(dom(Term_dom_S_sub.sub),Term.ONE)){ //4.1.2.2.2.1
              var Term_fund_S_fund_T_0=null;
              if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,"ψ("+fund(Term_dom_S_sub.sub,Term.ZERO)+","+bp(Term_fund_S_fund_T_0.sub)+")")+","+S.inner+")"; //4.1.2.2.2.1.1
              else return "ψ("+fund(S.sub,"ψ("+fund(Term_dom_S_sub.sub,Term.ZERO)+",0)")+","+S.inner+")"; //4.1.2.2.2.1.2
            }else{ //4.1.2.2.2.2
              var Term_fund_S_fund_T_0=null;
              if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner,S.inner)) return "ψ("+fund(S.sub,bp(Term_fund_S_fund_T_0.sub))+","+S.inner+")"; //4.1.2.2.2.2.1
              else return "ψ("+fund(S.sub,"ψ(0,0)")+","+S.inner+")"; //4.1.2.2.2.2.2
            }
          }
        }
      }
      ...
      var Term_fund_T_0=null;
      if (equal(T,(Term_fund_T_0=new Term(fund(T,Term.ZERO)))+"+"+Term.ONE)) return fund(S,Term_fund_T_0)+"+"+fund(S,Term.ONE); //4.2.1
      else return "ψ("+S.sub+","+fund(S.inner,Term.ZERO)+")"; //4.2.2
    }else{ //4.3
      if (lessThan(Term_dom_S_inner,S)) return "ψ("+S.sub+","+fund(S.inner,T)+")"; //4.3.1
      else{ //4.3.2
        if (!(Term_dom_S_inner instanceof PsiTerm&&equal(Term_dom_S_inner.inner,Term.ZERO))) throw Error("Failed assertion");
        var Term_fund_S_fund_T_0=null;
        if (equal(dom(Term_dom_S_inner.sub),Term.ONE)){ //4.3.2.1
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(Term_dom_S_inner.sub,Term.ZERO)+","+Term_fund_S_fund_T_0.inner+")")+")"; //4.3.2.1.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ("+fund(Term_dom_S_inner.sub,Term.ZERO)+",0)")+")"; //4.3.2.1.2
        }else{ //4.3.2.2
          var Term_fund_S_fund_T_0=null;
          if (equal(dom(T),Term.ONE)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.sub,S.sub)) return "ψ("+S.sub+","+fund(S.inner,Term_fund_S_fund_T_0.inner)+")"; //4.3.2.2.1
          else return "ψ("+S.sub+","+fund(S.inner,"ψ(0,0)")+")"; //4.3.2.2.2
        }
      }
    }
  }
...
var testTermsPre=[
  ...
  ["ψ_0(ψ_ψ_ω(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)(0)+ψ_ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)(0)+ψ_ψ_θ_0(0)(0)(ψ_θ_0(0)(0)))",3],
  ["ψ_0(ψ_θ_0(0)(0)+ψ_ψ_θ_0(0)(0)+1(0))",3],
  ["ψ_0(ψ_θ_0(0)(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)(1))",-1],
  ["ψ_0(ψ_θ_0(0)(ψ_θ_0(0)(0)))",3],
  ["ψ_0(ψ_θ_0(0)+1(0))",3],
  ["ψ_0(ψ_θ_0(0)+1(0)+ψ_ψ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)+1(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)+ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)+ψ_θ_0(0)(0)+ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)+ψ_θ_0(0)(ψ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_0(0)+ψ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(ψ_θ_0(0)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)(0))",3],
  ["ψ_0(ψ_θ_0(1)(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)(0)+ψ_θ_0(0)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)(0)+ψ_θ_0(1)(0))",-1],
  ["ψ_0(ψ_θ_0(1)(ψ_θ_0(0)(0)))",-1],
  ["ψ_0(ψ_θ_0(1)(ψ_θ_0(0)+1(0)))",-1],
  ["ψ_0(ψ_θ_0(1)(ψ_θ_0(0)+θ_0(0)(0)))",-1],
  ["ψ_0(ψ_θ_0(1)(ψ_θ_0(1)(0)))",3],
  ["ψ_0(ψ_θ_0(1)+1(0))",3],
  ["ψ_0(ψ_θ_0(1)+ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)+ψ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)+ψ_θ_0(0)+ψ_θ_0(1)+1(0)(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)+ψ_θ_0(1)(0)(0))",-1],
  ["ψ_0(ψ_θ_0(1)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(1)+θ_0(1)(0))",-1],
  ["ψ_0(ψ_θ_0(2)(0))",-1],
  ["ψ_0(ψ_θ_0(ω)(0))",-1],
  ["ψ_0(ψ_θ_0(ψ_1(0))(0))",-1],
  ["ψ_0(ψ_θ_0(ψ_ψ_θ_0(0)(0)(0))(0))",-1],
  ["ψ_0(ψ_θ_0(ψ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_ψ_θ_0(θ_0(0))(0)(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_θ_0(0)(ψ_θ_0(θ_0(0))(0)))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_θ_0(ψ_θ_0(θ_0(0))(0))(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_θ_0(ψ_θ_0(θ_0(0))(0))+1(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(0)+ψ_θ_0(θ_0(0))(0))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))(ψ_θ_0(θ_0(0))(0)))",3],
  ["ψ_0(ψ_θ_0(θ_0(0))+1(0))",-1],
  ["ψ_0(ψ_θ_0(θ_0(θ_0(0)))(0))",3],
  ["ψ_0(ψ_θ_1(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)(0)+ψ_θ_0(0)(ψ_θ_1(0)(0)))",3],
  ["ψ_0(ψ_θ_1(0)(0)+ψ_θ_0(ψ_θ_1(0)(0))(0))",3],
  ["ψ_0(ψ_θ_1(0)(0)+ψ_θ_0(θ_0(0))(0))",3],
  ["ψ_0(ψ_θ_1(0)(0)+ψ_θ_1(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)(1))",-1],
  ["ψ_0(ψ_θ_1(0)+1(0))",-1],
  ["ψ_0(ψ_θ_1(0)+ψ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)+ψ_θ_0(θ_0(0))(0)(0))",-1],
  ["ψ_0(ψ_θ_1(0)+ψ_θ_1(0)(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_0(0)(0)+ψ_θ_1(0)+ψ_θ_1(0)+θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_0(0)(0)+ψ_θ_1(0)+θ_0(0)(0))",-1],
  ["ψ_0(ψ_θ_1(0)+θ_0(ψ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_0(ψ_θ_1(0)(0))(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_0(θ_0(0))(0))",-1],
  ["ψ_0(ψ_θ_1(0)+θ_0(θ_1(0))(0))",3],
  ["ψ_0(ψ_θ_1(0)+θ_1(0)(0))",3],
  ["ψ_0(ψ_θ_1(1)(0))",-1],
  ["ψ_0(ψ_θ_1(θ_0(0))(0))",3],
  ["ψ_0(ψ_θ_1(θ_0(θ_1(0)))(0))",3],
  ["ψ_0(ψ_θ_1(θ_1(0))(0))",3],
  ["ψ_0(ψ_θ_2(0)(0))",3],
  ["ψ_0(ψ_θ_2(0)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_2(0)+θ_0(θ_2(0))(0))",3],
  ["ψ_0(ψ_θ_2(0)+θ_1(0)(0))",3],
  ["ψ_0(ψ_θ_2(0)+θ_1(θ_2(0))(0))",3],
  ["ψ_0(ψ_θ_2(0)+θ_2(0)(0))",3],
  ["ψ_0(ψ_θ_2(1)(0))",-1],
  ["ψ_0(ψ_θ_3(0)(0))",-1],
  ["ψ_0(ψ_θ_ω(0)(0))",3],
  ["ψ_0(ψ_θ_ψ_1(0)(0)(0))",3],
  ["ψ_0(ψ_θ_ψ_θ_0(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_ψ_θ_1(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_ψ_θ_θ_0(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_0(0)(ψ_θ_θ_0(0)(0)(0)))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_0(0)+ψ_θ_θ_0(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_0(ψ_θ_θ_0(0)(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_ψ_θ_θ_0(0)(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(0)+ψ_θ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)(1))",-1],
  ["ψ_0(ψ_θ_θ_0(0)(0)+1(0))",-1],
  ["ψ_0(ψ_θ_θ_0(0)(0)+ψ_ψ_θ_θ_0(0)(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+ψ_θ_ψ_θ_θ_0(0)(0)(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+ψ_θ_θ_0(0)(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_0(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_0(ψ_θ_θ_0(0)(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_0(θ_0(0))(0))",-1],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_0(θ_1(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_0(θ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_1(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_1(ψ_θ_θ_0(0)(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_1(θ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_2(0)(0))",-1],
  ["ψ_0(ψ_θ_θ_0(0)(0)+θ_θ_0(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(1)(0))",-1],
  ["ψ_0(ψ_θ_θ_0(0)(θ_0(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(θ_0(θ_0(0)))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(θ_1(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)(θ_θ_0(0)(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)+1(0)+θ_θ_0(0)(θ_θ_0(0)+1(0))(0))",3],
  ["ψ_0(ψ_θ_θ_0(0)+1(0)+θ_θ_0(0)+1(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(1)(0)(0))",-1],
  ["ψ_0(ψ_θ_θ_0(θ_1(0))(0)(0))",3],
  ["ψ_0(ψ_θ_θ_0(θ_θ_0(0)(0))(0)(0))",3],
  ["ψ_0(ψ_θ_θ_1(0)(0)(0))",3],
  ["ψ_0(ψ_θ_θ_ω(0)(0)(0))",-1],
  ["ψ_0(ψ_θ_θ_θ_0(0)(0)(0)(0))",3],
];
/** @type {string[]}} */
var testTerms;
