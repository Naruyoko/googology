    ...
    if (equal(Term_dom_S_inner3,Term.ZERO)){ //3.1
      ...
      if (equal(Term_dom_S_inner2,Term.ZERO)){ //3.1.1
        ...
        if (lessThan(Term_dom_S_inner2,S)) return "ψ("+S.inner1+","+fund(S.inner2,T)+","+S.inner3+")"; //3.1.3.1
          ...
          if (equal(dom(e),Term.ONE)){ //3.1.3.2.1
            ...
            if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)&&equal(Term_fund_S_fund_T_0.inner3,S.inner3)) return "ψ("+S.inner1+","+fund(S.inner2,"ψ("+d+","+fund(e,Term.ZERO)+","+Term_fund_S_fund_T_0.inner2+")")+","+S.inner3+")"; //3.1.3.2.1.1
            else return "ψ("+S.inner1+","+fund(S.inner2,"ψ("+d+","+fund(e,Term.ZERO)+",0)")+","+S.inner3+")"; //3.1.3.2.1.2
          }else{ //3.1.3.2.2
            var Term_fund_S_fund_T_0=null;
      ...
      if (lessThan(Term_dom_S_inner3,S)) return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,T)+")"; //3.3.1
        ...
        if (equal(dom(e),Term.ONE)){ //3.3.2.1
          var Term_fund_S_fund_T_0=null;
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)&&equal(Term_fund_S_fund_T_0.inner2,S.inner2)) return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+d+","+fund(e,Term.ZERO)+","+Term_fund_S_fund_T_0.inner3+")")+")"; //3.3.2.1.1
          else return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+d+","+fund(e,Term.ZERO)+",0)")+")"; //3.3.2.1.2
        }else{ //3.3.2.2
          var Term_fund_S_fund_T_0=null;
          if (isNat(T)&&(Term_fund_S_fund_T_0=new Term(fund(S,fund(T,Term.ZERO)))) instanceof PsiTerm&&equal(Term_fund_S_fund_T_0.inner1,S.inner1)&&equal(Term_fund_S_fund_T_0.inner2,S.inner2)){ //3.3.2.2.1
            if (lessThan(dom(S.inner2),Term_dom_S_inner3)) return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+fund(d,Term.ZERO)+","+Term_fund_S_fund_T_0.inner3+",0)")+")"; //3.3.2.2.1.1
            else return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+fund(d,Term.ZERO)+","+S.inner2+"+"+Term_fund_S_fund_T_0.inner3+",0)")+")"; //3.3.2.2.1.2
          }else return "ψ("+S.inner1+","+S.inner2+","+fund(S.inner3,"ψ("+fund(d,Term.ZERO)+",0,0)")+")"; //3.3.2.2.2
        }
      }
    }
  }
